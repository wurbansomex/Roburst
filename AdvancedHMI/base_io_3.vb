...
Public Class base_io_3
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles DigitalOutputs2Button.Click
    ...
    Private Sub base_io_3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
