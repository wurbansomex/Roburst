...
Public Class base_io_2
    ...
    Private Sub PgOpenIO2Button_Click(sender As Object, e As EventArgs)
        base_io_3.Show()
        Me.Visible = False
    End Sub
    ...
    Private Sub Button4_Click_1(sender As Object, e As EventArgs) Handles DigitalInputs1Button.Click
        base_io.Show() 'Digital Inputs 1 page
        Me.Visible = False
    End Sub

    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles AnalogsButton.Click
        base_io_3.Show() 'Analogs page
        Me.Visible = False
    End Sub

    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles DigitalOutputs1Button.Click
        base_io_4.Show() 'Digital Outputs 1 page
        Me.Visible = False
    End Sub

    Private Sub Button5_Click_1(sender As Object, e As EventArgs) Handles DigitalOutputs2Button.Click
    ...
    Private Sub base_io_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
