...
Public Class base_io_4
    ...
    Private Sub Label9_Click(sender As Object, e As EventArgs) Handles TestStationReleaseHeadLockLabel.Click
    ...
    Private Sub base_io_4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
