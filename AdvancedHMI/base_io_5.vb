...
Public Class base_io_5
    ...
    Private Sub Label9_Click(sender As Object, e As EventArgs) Handles WashDownValveLabel.Click
    ...
    Private Sub PgOpenHomeButton_Click_1(sender As Object, e As EventArgs) Handles PgOpenHomeButton.Click
        base_home.Show()
        Me.Visible = False
    End Sub

    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles StationSlowFillValveLabel.Click
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles DigitalInputs2Button.Click
    ...
    Private Sub base_io_5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
