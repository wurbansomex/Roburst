...
#Region "PLC Related Properties"
    ...
    '*****************************************************
    Private m_CommComponent As Drivers.IComComponent
    <System.ComponentModel.Category("PLC Properties")> _
    Public Property CommComponent() As Drivers.IComComponent
        Get
            Return m_CommComponent
        End Get
        Set(ByVal value As Drivers.IComComponent)
    ...
    Private Sub SubscribeToCommDriver()
        If Not DesignMode And IsHandleCreated Then
            ...
            If SubScriptions Is Nothing Then
                ...
                SubScriptions.ComComponent = m_CommComponent
            ...
            For i As Integer = 0 To p.Length - 1
                ...
                If p(i).Name.IndexOf("PLCAddress", StringComparison.CurrentCultureIgnoreCase) = 0 Then
                    ...
                    If (PLCAddress IsNot Nothing) AndAlso (String.Compare(PLCAddress, "") <> 0) Then
                        ...
                        If j < p.Length Then
                            SubScriptions.SubscribeTo(PLCAddress, PropertyToWrite, AddressOf PolledDataReturned)
                        End If
                    End If
                End If
            Next
...
#End Region
    ...
    Private Function subscrptionCallBack() As EventHandler(Of AdvancedHMIControls.SubscriptionHandlerEventArgs)
